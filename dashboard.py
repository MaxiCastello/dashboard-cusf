...
try:
    ...
    with c1:
        st.markdown('<div class="card">', unsafe_allow_html=True)
        header_with_select("Total de puntos", ["Totales"], "hdr_puntos", "Totales")
    ...
    with c2:
        st.markdown('<div class="card">', unsafe_allow_html=True)
        header_with_select("Composición de puntos", ["A favor","En contra"], "hdr_comp", "A favor")
        switch_card({"A favor": fig_f, "En contra": fig_c}, default_key="A favor", height=h_small, key="comp")
        st.markdown("</div>", unsafe_allow_html=True)

    with c3:
        st.markdown('<div class="card">', unsafe_allow_html=True)
        header_with_select("Precisión (Conv/Pen)", ["Conv/Pen"], "hdr_acc", "Conv/Pen")
    ...
    c1, c2, c3 = grid(3)
    with c1:
        header_with_select("Line", ["Totales","Propios","Rival"], "hdr_line", "Totales")
        switch_card({
        ...
        }, default_key="Totales", height=h_small, key="line")

    with c2:
        header_with_select("Scrum", ["Totales","Propios","Rival"], "hdr_scrum", "Totales")
        switch_card({
        ...
        }, default_key="Totales", height=h_small, key="scrum")

    with c3:
        header_with_select("Penales", ["Totales","Ruck","Juego","Scrum"], "hdr_pen", "Totales")
        switch_card({
        ...
        }, default_key="Totales", height=h_small, key="pen")

    # 4) Fila inferior: Salidas / Salidas 22 / Efectividad 22
    c1, c2, c3 = grid(3)
    with c1:
        header_with_select("Salidas", ["Totales","Propias","Rival"], "hdr_sal", "Totales")
        switch_card({
        ...
        }, default_key="Totales", height=h_small, key="salidas")

    with c2:
        header_with_select("Salidas de 22", ["Totales","Propias","Rival"], "hdr_sal22", "Totales")
        switch_card({
        ...
        }, default_key="Totales", height=h_small, key="salidas22")

    with c3:
        st.markdown('<div class="card">', unsafe_allow_html=True)
        header_with_select("Efectividad en 22", ["Serie"], "hdr_eff", "Serie")
