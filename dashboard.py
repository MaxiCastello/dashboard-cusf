...
try:
    ...
    if {
        ...
        st.write(f"**Total:** {row['salidas 22 total']} salidas 22")
        ...
        fig_total_22.update_layout(title=f"Salidas 22 Totales (Total {row['salidas 22 total']})")
        ...
        fig_propias_22.update_layout(title=f"Salidas 22 Propias (Total {total_propios_22})")
        ...
        fig_rival_22.update_layout(title=f"Salidas 22 Rival (Total {total_rival_22})")
