...
try:
    ...
    if fila_tot.any():
        ...
        total_pen_propios = int(penales["propios"].fillna(0).sum())  # respaldo

        # Leer cantidad de partidos desde hoja Info (2x2: Variable/Valor)
        ...
        # Mostrar conclusión debajo del gráfico de situaciones
