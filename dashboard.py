...
def generar_informe_pdf(
    ...
    W_FULL  = 520   # imagen a todo el ancho del área de texto
    W_HALF  = 290   # para dos graficos por fila
    W_THIRD = 210   # para tres graficos por fila
    ...
    if row_imgs:
        ...
        story.append(Table([row_imgs], colWidths=[W_THIRD]*len(row_imgs), hAlign="LEFT"))
        story.append(Spacer(1, 6))
    ...
    if pen_imgs:
        ...
        for r in rows:
            story.append(Table([r], colWidths=[W_HALF]*len(r), hAlign="LEFT"))
            story.append(Spacer(1, 6))
    ...
    for titulo_secc, trio in [
        ...
        if trio:
            ...
            story.append(Table([trio], colWidths=[W_THIRD]*len(trio), hAlign="LEFT"))
            story.append(Spacer(1, 6))
