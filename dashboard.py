...
if archivos:
    ...
    for archivo in archivos:
        ...
        with st.expander(f"📁 Datos del archivo: {os.path.basename(archivo)}", expanded=expandir_todo):
            ...
            fig.update_layout(
                ...
                xaxis=dict(title="Cantidad de Tackles", range=[0, 12], tick0=0, dtick=1),
                barmode="stack",
                height=altura
                )
            ...
            fig_torta.update_layout(height=600 if modo_celular else 500)
    ...
    if "nombre del jugador" in resumen_total.columns:
        ...
        fig_total.update_layout(
            ...
            barmode="stack",
            height=1300 if modo_celular else 900,
        ...
        fig_donut.update_layout(
            ...
            height=600 if modo_celular else 450
            )
        ...
        fig_global.update_layout(
            ...
            height=600 if modo_celular else 500
            )
