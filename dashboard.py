...
def generar_informe_pdf(
    ...
    #Estilos y tamaño
    buf_pdf = io.BytesIO()
    doc = SimpleDocTemplate(buf_pdf, pagesize=landscape(A4), leftMargin=28, rightMargin=28, topMargin=28, bottomMargin=28)
    ...
    W_HALF  = colw(2, gap=8)       # dos por fila
    W_THIRD = colw(3, gap=8)       # tres por fila
