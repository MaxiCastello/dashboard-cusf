...
try:
    ...
    if {"situacion", "a favor", "en contra", "motivo"}.issubset(set(penales.columns)):
        ...
        # --- GRÁFICO 1: Penales por situación específica (sin agrupar en categorías) ---
        ...
        # --- GRÁFICO 2: Detalle de penales en Ruck por motivo ---
        ...
        # --- GRÁFICO 3: Detalle de penales en Juego por motivo ---
        ...
        line_data = pd.read_excel(archivo_estadistica, sheet_name="Line")
        line_data.columns = line_data.columns.str.strip().str.lower()
    ...
    if {
            ...
            "totales perdidos",
            "total"
            }.issubset(set(line_data.columns)):
        ...
        fig_overall = px.pie(
            ...
            values="Cantidad", 
            hole=0.6,
            color_discrete_sequence=["#8A7BFF", "#8C5824"]
            )
        fig_overall.update_traces(textinfo='percent+label')
        fig_overall.update_layout(title="Overall Split")
        ...
        fig_propios.update_traces(textinfo='percent+label')
        fig_propios.update_layout(title="Lanzamientos Propios")
    ...
    # Grafico 3 Lanzamiento rival
        ...
        fig_rival.update_traces(textinfo='percent+label')
        fig_rival.update_layout(title="Lanzamientos Rival")
