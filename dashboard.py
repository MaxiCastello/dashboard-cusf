...
def generar_informe_pdf(
    ...
    if row_imgs:
        ...
        story.append(Table([row_imgs], colWidths=[230]*len(row_imgs), hAlign="LEFT"))
        story.append(Spacer(1, 6))
    ...
    for titulo_secc, trio in [
        ...
        trio = [fig_to_img(f, width_pt=230) for f in trio if f]
        if trio:
            story.append(Paragraph(titulo_secc, H2))
            story.append(Table([trio], colWidths=[230]*len(trio), hAlign="LEFT"))
            story.append(Spacer(1, 6))
